        ...
        <div class="sidebar-category sidebar-category-visible">
            <div class="category-content no-padding">
                <ul class="navigation navigation-main navigation-accordion">
                    ...
                    <li class="">
                        <a href="#"><i class="icon-home4"></i> <span>{{ trans('admin.sidebar.dashboard') }}</span></a>
                    </li>
                    <li class="">
                        <a href="#"><i class="icon-stack2"></i> <span>{{ trans('admin.sidebar.book') }}</span></a>
                        <ul>
                            <li class="">
                                <a href="{{ route('book.index') }}">{{ trans('admin.sidebar.listBook') }}</a>
                            </li>
                            <li class="">
                                <a href="{{ route('book.create') }}">{{ trans('admin.sidebar.newBook') }}</a>
                            </li>
                        </ul>
                    </li>
                    <li class="">
                        ...
                        <ul>
                            <li class="">
                                <a href="{{ route('category.index') }}">{{ trans('admin.sidebar.listCate') }}</a>
                            </li>
                            <li class="">
                                <a href="{{ route('category.create') }}">{{ trans('admin.sidebar.newCate') }}</a>
                            </li>
                        </ul>
                    </li>
                    <li class="">
                        ...
                        <ul>
                            <li class="">
                                <a href="{{ route('offices.index') }}">{{ trans('admin.sidebar.listOffice') }}</a>
                            </li>
                            <li class="">
                                <a href="{{ route('offices.create') }}">{{ trans('admin.sidebar.newOffice') }}</a>
                            </li>
                        </ul>
                    </li>
                    <li class="">
                    ...
                    <li class="">
                        ...
                        <ul>
                            <li class="">
                                <a href="{{ route('users.index') }}">{{ trans('admin.sidebar.listUser') }}</a>
                            </li>
                            <li class="">
                                <a href="{{ route('users.create') }}">{{ trans('admin.sidebar.newUser') }}</a>
                            </li>
                        </ul>
                    </li>
                    <li class="">
                    ...
                    <li class="">
                        <a href="{{ route('setting') }}"><i class="icon-home4"></i> <span>{{ trans('admin.option.option') }}</span></a>
                    </li>
                </ul>
            </div>
        </div>
